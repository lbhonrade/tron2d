...
public class TButton extends JLabel implements MouseListener {
	private static final long serialVersionUID = 6982891131901718010L;
	protected int xo = 0;
	protected int yo = 0;
	protected JXLabel text;
	protected JXImagePanel hoveredBG, commonBG, pressedBG;
	...
	public TButton(String label, int xi, int yi) {
		...
		if (label == null)
			label = "";
		text = new JXLabel(label);
		text.setBounds(0, 0, TConstants.UNSELECTED_BTN_BG.getWidth(),
				TConstants.UNSELECTED_BTN_BG.getHeight());
		text.setHorizontalAlignment(SwingConstants.CENTER);
		text.setFont(TUtils.getFont(TConstants.FONT_BATTLEFIELD3).deriveFont(
				21f));
		text.setForeground(new Color(18, 149, 241));
		this.add(text);

		pressedBG = new JXImagePanel();
		pressedBG.setBounds(0, 0, TConstants.PRESSED_BTN_BG.getWidth(),
				TConstants.PRESSED_BTN_BG.getHeight());
		pressedBG.setImage(TConstants.PRESSED_BTN_BG);
		...
		hoveredBG.setBounds(0, 0, TConstants.HOVERED_BTN_BG.getWidth(),
				TConstants.HOVERED_BTN_BG.getHeight());
		hoveredBG.setImage(TConstants.HOVERED_BTN_BG);
		...
		commonBG.setBounds(0, 0, TConstants.UNSELECTED_BTN_BG.getWidth(),
				TConstants.UNSELECTED_BTN_BG.getHeight());
		commonBG.setImage(TConstants.UNSELECTED_BTN_BG);
		commonBG.setStyle(Style.SCALED);
		commonBG.setOpaque(false);
		this.add(commonBG);

		this.setBounds(xo, yo, TConstants.UNSELECTED_BTN_BG.getWidth(),
				TConstants.UNSELECTED_BTN_BG.getHeight());
	...
	public void mousePressed(MouseEvent e) {
		// TODO Auto-generated method stub
		Animation.FadeIn(pressedBG, 100);
	}
	...
	public void mouseEntered(MouseEvent e) {
		// TODO Auto-generated method stub
		new Sound("audio/btnhoversound.wav").start();
		text.setForeground(Color.WHITE);
		Animation.FadeIn(hoveredBG, 500);
