	...
	public DialogContent(String title) {
		...
		setBounds(
				...
				TConstants.MENU_SCREEN_HEIGHT / 2
						- TConstants.DIALOG_BG_TL.getHeight() + 50,
				TConstants.DIALOG_BG_TL.getWidth() * 2,
				TConstants.DIALOG_BG_TL.getHeight() * 2);
		setOpaque(false);
		setAlpha(0f);
		setVisible(false);
		...
		dialogLabel.setFont(TUtils.getFont(TConstants.FONT_BATTLEFIELD3)
				.deriveFont(21f));
		dialogLabel.setHorizontalAlignment(SwingConstants.RIGHT);
		add(dialogLabel);

		scrollPane = new JScrollPane();
		scrollPane.setBounds(25, 50, this.getWidth() - 50,
				this.getHeight() - 100);
