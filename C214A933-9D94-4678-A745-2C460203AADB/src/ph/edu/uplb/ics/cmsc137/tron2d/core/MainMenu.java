...
public class MainMenu extends JFrame implements MouseListener {
	...
	public MainMenu() throws SlickException, Exception {
		setResizable(false);
		setBounds(0, 0, TConstants.MENU_SCREEN_WIDTH,
				TConstants.MENU_SCREEN_HEIGHT);
		...
		TMenuButton playBtn = new TMenuButton("PLAY NOW!",
				TConstants.MENU_SCREEN_WIDTH / 2
						- TConstants.UNSELECTED_BTN_BG.getWidth(),
		...
		TMenuButton settingsBtn = new TMenuButton("SETTINGS",
				TConstants.MENU_SCREEN_WIDTH / 2, TConstants.MENU_SCREEN_HEIGHT
						/ 2 - TConstants.UNSELECTED_BTN_BG.getHeight() - 14, -1
						* TConstants.UNSELECTED_BTN_BG.getWidth(), -1
						* TConstants.UNSELECTED_BTN_BG.getHeight()) {
		...
		TMenuButton aboutBtn = new TMenuButton("ABOUT",
				TConstants.MENU_SCREEN_WIDTH / 2 - 18,
				TConstants.MENU_SCREEN_HEIGHT / 2 - 14, -1
						* TConstants.UNSELECTED_BTN_BG.getWidth(),
				TConstants.MENU_SCREEN_HEIGHT) {
		...
		TMenuButton instructionsBtn = new TMenuButton("INSTRUCTIONS",
				TConstants.MENU_SCREEN_WIDTH / 2
						- TConstants.UNSELECTED_BTN_BG.getWidth() - 18,
				TConstants.MENU_SCREEN_HEIGHT / 2,
				TConstants.MENU_SCREEN_WIDTH, TConstants.MENU_SCREEN_HEIGHT) {
		...
		bgLabel.setBounds(0, 0, TConstants.MENU_SCREEN_WIDTH,
				TConstants.MENU_SCREEN_HEIGHT);
