...
public class MainMenu extends JFrame implements MouseListener{
	...
	public MainMenu() throws SlickException, Exception {
		...
		TMenuButton spectateBtn = new TMenuButton("SPECTATE GAMES", TConstants.MENU_SCREEN_WIDTH/2, TConstants.MENU_SCREEN_HEIGHT/2-TConstants.UNSELECTED_BTN_BG.getIconHeight()-14,-1*TConstants.UNSELECTED_BTN_BG.getIconWidth(),-1*TConstants.UNSELECTED_BTN_BG.getIconHeight()){
			@Override
			public void mouseReleased(MouseEvent e) {
				super.mouseReleased(e);
				MainMenu main = (MainMenu)this.getRootPane().getParent();
				main.dialogContent.setTitle("Viewing Area");
			}
		};
			spectateBtn.setTextFont(spectateBtn.getTextFont().deriveFont(17f));
		...
		this.getContentPane().add(spectateBtn);
